...
class GridSearch:
    ...
    def best(self,result:dict,topk:int=3,using:str='mean',should_print:bool=False):
        ...
        Args:
            result (dict): Result dict generated by self.fit
            topk (int, optional): `k` best set of parameters. Defaults to 3.
            using (str, optional): What should be used to judge the performance of a set ('mean','min','max','std','last'). Defaults to 'mean'.
            should_print (bool, optional): Print table of best `k`. Defaults to False.
